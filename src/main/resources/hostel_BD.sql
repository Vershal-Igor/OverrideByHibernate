...
START TRANSACTION;
USE `Hostel`;
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (1, 1, 2, 5.25);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (2, 2, 2, 5.45);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (3, 3, 3, 10.25);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (4, 4, 3, 10);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (5, 5, 4, 15);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (6, 6, 5, 20);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (7, 7, 6, 25);
INSERT INTO `Hostel`.`Room` (`r_id`, `room_number`, `room_places`, `price`) VALUES (8, 8, 4, 12.50);
...
START TRANSACTION;
USE `Hostel`;
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (1, '2017.02.22', '2017.02.24', 2, 0, 0, 1, 2, 1);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (2, '2017.02.24', '2017.02.26', 2, 1, 0, 1, 3, 2);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (3, '2017.02.24', '2017.02.27', 3, 1, 0, 0, 4, 3);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (4, '2017.02.25', '2017.02.28', 3, 0, 0, 1, 5, 4);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (5, '2017.03.01', '2017.03.03', 4, 1, 0, 2, 6, 5);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (6, '2017.03.04', '2017.03.05', 5, 1, 0, 0, 7, 6);
INSERT INTO `Hostel`.`Order` (`o_id`, `arrival_date`, `depature_date`, `places_amount`, `pay_type`, `discount`, `status`, `User_id`, `Room_id`) VALUES (7, '2017.03.04', '2017.03.06', 6, 0, 0, 3, 8, 7);
